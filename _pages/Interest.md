...
<details open>
    ...
    <ul tyep="square">
        ...
        <li><p>Requirements:<br>
            <u>Completeness</u>: If the answer is true, the honest <i>V</i> will be convinced of this face by an honest <i>P</i>.<br>
            <u>Soundness</u>: If the answer is false, no cheating <i>P</i> can convince the honest <i>V</i> that it is true, except with some small probability.</p>
        </li>
